...
$libPath = CakePlugin::path('OAuth') . 'Vendor' . DS .  'oauth-php' . DS . 'lib'. DS;

require_once($libPath . 'Oauth2.php');
require_once($libPath . 'IOAuth2Storage.php');
require_once($libPath . 'IOAuth2GrantCode.php');
require_once($libPath . 'IOAuth2GrantUser.php');
require_once($libPath . 'IOAuth2GrantClient.php');
require_once($libPath . 'IOAuth2GrantImplicit.php');
require_once($libPath . 'IOAuth2RefreshTokens.php');
require_once($libPath . 'OAuth2Exception.php');
require_once($libPath . 'OAuth2RedirectException.php');
require_once($libPath . 'OAuth2ServerException.php');
